<template>
    <div tabindex="-1" class=" bg-[#000000b9] fixed  flex items-center z-50 md:inset-0 h-modal md:h-full">
        <div class="bg-white w-[60%] m-auto mt-6 p-2 rounded pb-4 " v-click-outside="onClickOutside">
            ...
            <div class="px-2 h-[33rem] overflow-auto">
              <div class="">
                <div class="relative">
              ...
              <div
                ...
                <div class="general-information w-[36%]">
                  <div>
                    ...
                    <div class="flex mt-2">
                      ...
                      <span class="ml-3 text-md ">{{alumni['batch']}}</span>
                    </div>
                    <div class="flex items-center">
                      ...
                      <span class="ml-3 text-md ">{{alumni['major']}}</span>
                    </div>
                    <div class="flex items-center">
                    ...
                    <div class="flex">
                      ...
                      <span class="ml-3 text-md">{{alumni['phone']}}</span>
                    </div>
                    <div class="flex">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span class="ml-2 text-md">{{alumni['email']}}</span>
                    </div>
                  </div>
                  <card-skill 
                  :alu_id="alumni['id']" 
