...
<form class="border-2 border-sky-400 w-[76%] m-auto mt-5 rounded-sm">
    <table class=" table-auto w-[98%] flex flex-wrap m-auto mt-5">
        <thead class="w-[95%] flex flex-wrap m-auto shadow-sm p-4">
        ...
        <tbody v-for:="company in companies" class="w-[95%] flex flex-wrap m-auto shadow-sm p-4" >
                <tr class="w-[35%] m-auto  ">
                    <td class="w-[30%] m-1">
                        <div class="w-16 h-16 border-2 border-blue-500  rounded-full">
                            <img :src="'http://127.0.0.1:8000/images/profile/'+company.profile" class="w-[70%] m-auto mt-3">
                        </div>
                    </td>
                    <td>
                        <p>{{company.name}}</p>
