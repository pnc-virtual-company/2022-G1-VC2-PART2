    ...
    <div tabindex="-1" class=" bg-[#000000b9] fixed  flex items-center z-50 md:inset-0 h-modal md:h-full">
        <div class="modal bg-white h-auto shadow-md rounded p-5 mt-2 mb-10 m-auto w-[40%] z-10">
            ...
            <div v-if="companies!=null" class="w-[100%] my-2 flex items-center p-2">
                ...
                <select v-model="companyId" class="block p-2 w-full outline-none text-gray-900 bg-gray-50 rounded-sm border border-gray-300 sm:text-xs focus:ring-blue-500">
            ...
            <div class="date flex justify-between my-2 p-0">
                ...
                <input v-model="start_year" type="date" class="block p-2 w-full outline-none text-gray-900 bg-gray-300 rounded-sm border border-gray-300 sm:text-xs focus:ring-blue-500">
                </div>
                <div class="w-[100%] mx-2 text-start">
                <label class="mb-2 w-[10rem] text-start text-sm font-bold">End date: </label>
                <input v-model="end_year" type="date" class="block p-2 w-full outline-none text-gray-900 bg-gray-300 rounded-sm border border-gray-300 sm:text-xs focus:ring-blue-500">
            </div>
        </div>
