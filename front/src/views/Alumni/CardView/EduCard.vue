<template>
    <div class="border-[2px] border-skyblue p-3 rounded mt-4">
        ...
        <div v-for:="(education, i) in educations"  class="flex justify-between mt-2 p-2 border-b-[1px] border-[#a9aaaaa3]">
            ...
            <div>
                <!-- <svg @click="$emit('isEdit-edu',education)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:cursor-pointer hover:font-lg">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM18.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg> -->
                <svg id="i" @click="isClick= true, id = i" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:cursor-pointer hover:font-lg">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM18.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>
                <div v-if="isClick && id == i" class="absolute bg-slate-300 rounded mt-[-30px] ml-[30px] text-[14px]">
                    ...
                    <p class="flex items-center hover:cursor-pointer hover:bg-skyblue py-1 px-3 hover:text-white hover:rounded-bl hover:rounded-br" @click="$emit('isEdit-edu',education), isClick=false">
                        <span class="mr-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
