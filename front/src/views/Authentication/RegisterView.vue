    ...
    <div class="flex h-full items-center ml-10">
      ...
      <div class="rounded mb-2 w-[40%] m-auto mt-[15px]">
        <form class="p-3 bg-[#CCE7F6] rounded mr-10 border-white">
          <h1 class="text-2xl font-semibold text-center p-1 mt-3">INPUT INFORMATION</h1>
          <div v-if="step1">
            ...
            <div class="mb-2 relative w-[99%] m-atuo">
              ...
              <input
                ...
                :type="showpassword"
                class="shadow border rounded w-full py-2.5 px-2 text-sm text-gray-700 mb-1 leading-tight outline-none focus:shadow-outline focus:border-[#22bbea]"
                :class="{ 'border-red-500 bg-red-100': is_password }"
                id="password"
          ...
          <div v-else>
            ...
            <div class="flex">
              <div class="w-[49%] m-1">
                ...
                >
                  ...
                  <option :value="2021 - i" v-for:="(year, i) in 15">
                    {{ 2021 - i }}
                  </option>
                </select>
              </div>
            ...
            <div class="ml-2">
              <label class="block text-gray-700 text-lg mb-1 mt-4"
              ...
              <div class="flex">
                <div class="flex items-center mb-4">
                  <input
                    ...
                    id="m"
                  />
                  <label class="ml-2 text-sm font-medium text-gray-600" for="m"
                    >Male</label
                  >
                </div>
                <div class="flex items-center mb-4 ml-2">
                  <input
                    ...
                    class="w-4 h-4 bg-white border-gray-300 dark:ring-offset-gray-800 focus:ring-2"
                  />
                  <label class="ml-2 text-sm font-medium text-gray-600" for="f"
                    >Female</label
                  >
                </div>
                <div class="flex items-center mb-4 ml-2">
                  ...
                  />
                  <label class="ml-2 text-sm font-medium text-gray-600" for="other"
                    >Other</label
                  >
                </div>
              </div>
