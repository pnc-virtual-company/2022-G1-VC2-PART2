<template>
 <table class=" table-auto w-[98%] flex flex-wrap m-auto mt-5">
        <tbody  class="w-[95%] flex flex-wrap m-auto mt-2 shadow-md p-2">
          ...
          <tr class="w-[10%] m-auto">
              <td class="w-[100%]">
                  <div class="w-[40%] bg-red-500 rounded-md cursor-pointer p-1 shadow-sm border-b">
                      <svg @click="$emit('remove-univer',university_id)" xmlns="http://www.w3.org/2000/svg" fill="none" class="w-[50%] m-auto" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
