<template>
    <!--  list Form-->
    <form class="border-2 border-blue-500 w-[76%] m-auto mt-5 rounded-md">
        <!-- header -->
        <div class="w-[93%] flex flex-wrap m-auto mt-5">
            <div class="w-[25%]">
                <select class="w-[90%] border-2 border-gray-500 p-2 shadow-md rounded-md cursor-pointer">
            ...
            <div class="w-[50%] border-2 border-gray-700 mr-5 rounded-md shadow-md p-2 flex flex-wrap">
                <div class="w-[80%] m-auto">
                    <input type="text" placeholder="Search..." class="w-[100%] outline-none">
                </div>
    ...
    <table class=" table-auto w-[98%] flex flex-wrap m-auto mt-5">
        <thead class="w-[95%] flex flex-wrap m-auto shadow-md p-4 cursor-pointer">
        ...
        <tbody class="w-[95%] flex flex-wrap m-auto mt-5 mb-10 p-4 shadow-md  ">
                ...
                <tr class="w-[20%] m-auto flex flex-wrap">
                    ...
                    <td class="w-[55%] m-auto">
                        <h5 class="text-md">Kimky Mao</h5>
                    </td>
                </tr>
                <tr class="w-[35%] m-auto">
                    <td class="w-[60%] m-auto">
                        <p>kimky.mao@student.passerellesnumeriques.org</p>
                    </td>
                </tr>
                <tr class="w-[15%] m-auto">
                    <td class="w-[100%]">
                ...
                <tr class="w-[15%] m-auto">
                    <td class="w-[100%]">
                        <p class="text-bold">active</p>
                    </td>
                </tr>
                <tr class="w-[15%] m-auto">
                    <td class="w-[100%]">
                        <div class="w-[40%] bg-red-500 rounded-md cursor-pointer p-1 shadow-md">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-[30%] m-auto" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
