    ...
    <div style="width: 90%; margin: auto; height: 50vh; background: #22bbea63; border-radius: 5px; padding-top: 2rem;">
        <div style="width: 70%; height: 88%; border-radius: 5px; background: white; margin:auto;">
            ...
            <div style="width:90%; margin:auto; margin-top: 1rem; ">
                <p>Dear Teacher,</p>
                <p>There is a new register alumni account. Please take a look at the account details below :</p>
                <p>Name : <strong>{{$details['first_name']}} {{$details['last_name']}} ( {{$details['alumni']['major']}} {{$details['alumni']['batch']}} ) </strong></p>
                <p>Email : <a href="#"  style="text-decoration: none; color:black;"><strong>{{$details['email']}} </strong></a></p>
                <p>For more information <strong><a href="http://localhost:5173/" style="text-decoration: none;">Click here</a></strong></p>
            </div>
        </div>
    </div>
</body>
