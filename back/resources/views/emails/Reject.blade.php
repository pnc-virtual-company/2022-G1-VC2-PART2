    ...
    <div style="width: 90%; margin: auto; height: 50vh; background: #22bbea63; border-radius: 5px; padding-top: 2rem;">
        <div style="width: 70%; height: 88%; border-radius: 5px; background: white; margin:auto;">
            ...
            <div style="width:90%; margin:auto; margin-top: 1rem; ">
                ...
                <p>Your account has been rejected from the PNC ALUMNI MANAGEMENT APPLICATION. Please re-register your new account to communicate with PNC alumni.</p>
                <p><a href="http://localhost:5173/"  style="text-decoration: none;"><strong>Cick here</strong></a></p>
            </div>
        </div>
    </div>
</body>
